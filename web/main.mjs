...
const testData = new Map([
	...
	[
		'v15.1.0',
		{
			...
			identifierStart: String.raw`\u{1123F}`, // Same as v15.0.0.
			identifierPart: String.raw`\u200C`,
		},
	],
	[
		'v15.0.0',
		{
			propertyEscape: 'Script=Kawi',
			identifierStart: String.raw`\u{1123F}`,
			identifierPart: String.raw`\u0CF3`,
		},
	],
	[
		'v14.0.0',
		{
			propertyEscape: 'Script=Toto',
			identifierStart: String.raw`\u0870`,
			identifierPart: String.raw`\u0898`,
		},
	],
	[
		'v13.0.0',
